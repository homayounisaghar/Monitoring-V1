...
export function NavFrame() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-full max-w-[1320px] items-center gap-4 px-6">
        ...
        {/* RIGHT — tabs + utilities */}
        <div className="flex items-center gap-5">
          {/* Tabs — the only green-underline idiom */}
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger
                className="ml-1 grid h-8 w-8 place-items-center rounded-full outline-none transition-opacity hover:opacity-90 focus-visible:ring-2 focus-visible:ring-[var(--color-brand)] focus-visible:ring-offset-1"
                style={{ backgroundColor: "var(--color-brand)" }}
