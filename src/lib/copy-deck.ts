...
export const COPY = {
  ...
  "periods.axisNote": "per-min rate · 100 = session avg · drawn scale 30–150",
  "periods.gap.label": "gap E−I · pts",
  "periods.peakChip": "peak",
  "periods.unit.m": "m",
  "periods.unit.ct": "ct",
  "periods.unit.cl": "CL",
  "periods.legend.axes": "external — work · internal — cost",
  "periods.legend.columns": "columns: per-min rate vs the 100 line · above stands on the line · below hangs clear",
  "periods.legend.states": "• thin coverage · ring + hatch unconfirmed · break = past drawn scale · — no data",
  "periods.legend.gap": "gap E−I = distance rate − Cardio Load rate · hover a block for detail",
  "periods.hover.pastScale": "past drawn scale (30–150)",
  ...
  "periods.hover.rowLabel.total": "Total distance",
  "periods.hover.rowLabel.hsr": "High-speed running",
  "periods.hover.rowLabel.accDec": "Accel + decel",
  "periods.hover.rowLabel.cardio": "Cardio Load",
