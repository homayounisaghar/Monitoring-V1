...
export const COPY = {
 ...
 "readingLine.bgloss.typical_match": "a typical match of this type",
  ...
  // Benchmark option labels — mirror session-scope.BENCHMARK_OPTIONS verbatim,
  // plus the Longitudinal-default typical_daytype authored here.
  "longi.bench.opt.typical_daytype": "typical, like-for-like",
  "longi.bench.opt.typical_match":   "typical match",
  "longi.bench.opt.last_match":      "last match",
  "longi.bench.opt.last_5":          "last 5 matches",
  "longi.bench.opt.same_opponent":   "same opponent",
  "longi.bench.gloss.typical_daytype": "each day vs its own typical",
  "longi.bench.gloss.typical_match":   "the day-type typical of a match",
  "longi.bench.gloss.last_match":      "the squad's previous match",
  "longi.bench.gloss.last_5":          "average of the squad's last five matches",
  "longi.bench.gloss.same_opponent":   "squad output vs this opponent before",

  // Reference option labels — six options across three families.
  "longi.ref.opt.own_typical":   "their typical, day-aware",
  "longi.ref.opt.last_5":        "last 5 matches",
  "longi.ref.opt.season":        "season average",
  "longi.ref.opt.positional":    "positional norm",
  "longi.ref.opt.cohort":        "squad average",
  "longi.ref.opt.same_opponent": "same opponent",
  "longi.ref.gloss.own_typical":   "their own typical for that day type",
  "longi.ref.gloss.last_5":        "their last 5 matches",
  "longi.ref.gloss.season":        "their season average",
  "longi.ref.gloss.positional":    "typical for their position group",
  "longi.ref.gloss.cohort":        "this squad, day-matched",
  "longi.ref.gloss.same_opponent": "the reverse fixture",
