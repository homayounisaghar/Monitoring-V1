...
export const COPY = {
  ...
  "legend.dot": "dot — this session · ±% vs reference",
  "legend.trustDot": "trust dot — coverage under 80%",
  "legend.flagGlyph": "flag — flagged in Attention",
  "legend.gapPair": "pair — distance vs cardio gap (pts)",
  "legend.unconfirmed": "ring + hatch — unconfirmed",
  "legend.breakGlyph": "break — beyond chart range",
  ...
  "legend.break": "break — beyond drawn range, value printed",
  ...
  "periods.axisNote": "per-min rate · 100 = session avg",
  "periods.gap.label": "distance vs cardio gap (pts)",
  "periods.peakChip": "peak",
  "periods.unit.m": "m",
  "periods.unit.ct": "ct",
  "periods.unit.cl": "CL",
  "periods.legend.states": "thin coverage · ring + hatch unconfirmed · break = beyond drawn range, exact % shown · — no data",
  ...
  "periods.hover.pastScale": "beyond drawn range",
 ...
 "readingLine.bgloss.typical_match": "a typical match of this type",
  ...
  "longi.bench.opt.full_matches":     "full matches",
  ...
  "longi.ref.opt.full_matches":     "their full matches",
  ...
  "athlete.summary.basisTemplate": "% of {ref}",
