...
public final class MainActivity extends Activity {
    ...
    private View makeContentView() {
        ...
        title.setText("Mouse Button Toggle 1.0.9");
        ...
        if (MouseSettingsController.isSamsungDevice()) {
            description.setText("Restored seamless Samsung mode. One Quick Settings control switches the physical mouse primary button between Left and Right.\n\nSamsung protects this setting from ordinary app writes, so this version uses the proven v1.0.6 Accessibility helper path again: it hides the Samsung Settings transition behind a short in-memory screen cover and returns to the exact app you were using. Shizuku is not required for daily use.");
        } else {
            description.setText("One Quick Settings control switches the physical mouse primary button between Left and Right.\n\nGrant Android's Modify system settings permission once, then the tile works independently.");
        }
