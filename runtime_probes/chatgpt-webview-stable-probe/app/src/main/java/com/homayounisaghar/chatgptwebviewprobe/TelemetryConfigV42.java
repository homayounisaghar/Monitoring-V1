...
final class TelemetryConfigV42 {
    static final String WEBHOOK_URL = "https://webhook.site/__V42_UNCONFIGURED__";
    ...
    private TelemetryConfigV42() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V42_UNCONFIGURED__");
    }
}
