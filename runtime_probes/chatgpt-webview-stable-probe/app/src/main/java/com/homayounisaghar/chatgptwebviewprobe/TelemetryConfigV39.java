...
final class TelemetryConfigV39 {
    static final String WEBHOOK_URL = "https://webhook.site/__V39_UNCONFIGURED__";
    ...
    private TelemetryConfigV39() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V39_UNCONFIGURED__");
    }
}
