...
final class TelemetryConfigV32 {
    static final String WEBHOOK_URL = "https://webhook.site/__V32_UNCONFIGURED__";
    ...
    private TelemetryConfigV32() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V32_UNCONFIGURED__");
    }
}
