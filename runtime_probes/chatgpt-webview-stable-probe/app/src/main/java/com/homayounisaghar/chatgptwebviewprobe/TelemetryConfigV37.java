...
final class TelemetryConfigV37 {
    static final String WEBHOOK_URL = "https://webhook.site/__V37_UNCONFIGURED__";
    ...
    private TelemetryConfigV37() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V37_UNCONFIGURED__");
    }
}
