...
final class TelemetryConfigV29 {
    static final String WEBHOOK_URL = "https://webhook.site/__V29_UNCONFIGURED__";
    ...
    private TelemetryConfigV29() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V29_UNCONFIGURED__");
    }
}
