...
final class TelemetryConfigV26 {
    static final String WEBHOOK_URL = "https://webhook.site/__V26_UNCONFIGURED__";
    ...
    private TelemetryConfigV26() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V26_UNCONFIGURED__");
    }
}
