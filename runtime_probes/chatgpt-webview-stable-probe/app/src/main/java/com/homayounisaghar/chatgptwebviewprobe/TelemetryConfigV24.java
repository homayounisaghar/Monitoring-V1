...
final class TelemetryConfigV24 {
    static final String WEBHOOK_URL = "https://webhook.site/__V24_UNCONFIGURED__";
    ...
    private TelemetryConfigV24() {}

    static boolean isConfigured() {
        return CONFIGURED && WEBHOOK_URL.startsWith("https://webhook.site/")
                && !WEBHOOK_URL.contains("__V24_UNCONFIGURED__");
    }
}
